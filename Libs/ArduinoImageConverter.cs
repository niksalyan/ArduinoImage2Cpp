...
public static class ArduinoImageConverter
{
    ...
    public sealed class IndexedImage
    {
        ...
        public string ToArduinoCode(DataModel data)
        {
            ...
            // Build pixel data string separately
            var dataSb = new StringBuilder();
            dataSb.AppendLine($"const uint8_t {identifier}[] PROGMEM =");
            dataSb.AppendLine("{");
            AppendByteArray(dataSb, Data);
            dataSb.AppendLine("};");

            // Build palette lines grouped like the Box converter
            string paletteEntries = String.Join("", Palette.Select((p, i) =>
                $"  0x{ToRgb565(p):X4}{(i % 8 == 7 ? ",\r\n  " : ", ")}"));

            bool hasTransparency = TransparentIndex >= 0 && this.TransparentIndex < Palette.Length;

            sb.AppendLine(@$"// ============================================================
// Generated by ArduinoImageConverter - {macroName}
// ============================================================

#define {macroName}_WIDTH       {Width}
#define {macroName}_HEIGHT      {Height}
#define {macroName}_BPP         {BitsPerPixel}
#define {macroName}_COLORS      {ColorsCount}
#define {macroName}_DATA_SIZE   {Data.Length}
...
");
            ...
            // Include render function if requested
